    ...
    return (
        <main className="[&>*]:animate-fade-in-1.5 relative z-10">
            <section className="text-center text-sky-100">
                ...
                <p className="text-[20px] font-zilla max-w-xl mt-14">Always learning new technologies, fascinated by solving bugs, developing new softwares and creating wonderful experiences. I am a Front End Developer who is very enthusiast with Full Stack, with huge love for Flutter/Dart, NextJs, but also loves JavaScript.</p>
            </section>
        </main>
    )
}